...
result['Sheet1'].forEach(element => {
  ...
  if(element["SKU 1"])
  tempElement["articles"].push({"match_type": "exact","sku":element["SKU 1"]})
  if(element["SKU 2"])
  tempElement["articles"].push({"match_type": "exact","sku":element["SKU 2"]})
  if(element["SKU 3"])
  tempElement["articles"].push({"match_type": "exact","sku":element["SKU 3"]})
  if(element["SKU 4"])
  tempElement["articles"].push({"match_type": "exact","sku":element["SKU 4"]})
  if(element["SKU 5"])
  tempElement["articles"].push({"match_type": "exact","sku":element["SKU 5"]})
  if(element["SKU 6"])
  tempElement["articles"].push({"match_type": "exact","sku":element["SKU 6"]})
